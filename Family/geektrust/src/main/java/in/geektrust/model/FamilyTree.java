...
import in.geektrust.service.AddChild;
import in.geektrust.service.AddChildImpl;
import in.geektrust.service.GetRelationship;
import in.geektrust.service.GetRelationshipImpl;
...
public class FamilyTree {
	...
	public FamilyTree(Person queen) {
		this.queen = queen;
	}
	...
	public Person searchPerson(Person person, String name) {
		...
		if (person.getSpouse()!= null && person.getSpouse().getName().equals(name)) { //Spouse
